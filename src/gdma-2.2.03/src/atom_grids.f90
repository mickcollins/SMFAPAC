...
DOUBLE PRECISION, ALLOCATABLE :: r(:), w_r(:), gr(:)
...
DOUBLE PRECISION :: slater_radius(0:54) = (/ 0.65d0, 0.50d0, 0.50d0,   &
...
DOUBLE PRECISION :: rscale=2d0

DOUBLE PRECISION :: xleg(135), wleg(135)
...
DOUBLE PRECISION, INTENT(IN) :: c(:,:), radius(:)

INTEGER :: a, b, g, i, m, ma, mb, n, p, q, ok
DOUBLE PRECISION, ALLOCATABLE :: rr(:,:), aa(:,:), s(:,:), pp(:)
DOUBLE PRECISION :: chi, u, mu_ab, nu_ab, weight, f
...
DOUBLE PRECISION :: c(0:31), s(0:31), zz, xy, ww

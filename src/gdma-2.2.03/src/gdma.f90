...
INTEGER :: nextra=16
INTEGER :: ncoorb, maxl, cmax, nprim
INTEGER, ALLOCATABLE :: shell_type(:)
INTEGER :: i, j, k, kp=0
LOGICAL :: eof, fchk, first, ok=.false.

DOUBLE PRECISION, ALLOCATABLE :: densty(:,:), dtri(:)
...
DOUBLE PRECISION :: e, rt3v2, td(5,6), tf(7,10), tg(9,15)
...
DOUBLE PRECISION, PARAMETER :: rt2=1.4142135623731d0,                  &
    rt3=1.73205080756888d0, rt5=2.23606797749979d0, rt7=2.64575131106459d0
DOUBLE PRECISION, PARAMETER :: rt10=rt2*rt5, rt14=rt2*rt7, rt21=rt3*rt7, &
    rt35=rt5*rt7

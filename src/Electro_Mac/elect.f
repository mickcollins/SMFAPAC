      subroutine elect(L1max,natom1,c1,ch1,d1,qu1,
     .                 natom2,c2,ch2,d2,qu2,
...
c       del2(n2,k2) - the derivative of el wrt coordinate k2 of atom n2
      ...
      dimension c1(L1max,3),ch1(L1max),d1(L1max,3),
     .          qu1(L1max,3,3)

      dimension c2(L1max,3),ch2(L1max),d2(L1max,3),
     .          qu2(L1max,3,3)
...
c     call ct3o_d(ch2(n2),oct1(n1,:,:,:),t4,dect3oa)
c     call ct3o_d(ch1(n1),oct2(n2,:,:,:),t4,dect3ob)
c     call ct4h_d(ch2(n2),hex1(n1,:,:,:,:),t5,dect4ha)
c     call ct4h_d(ch1(n1),hex2(n2,:,:,:,:),t5,dect4hb)
      call dt2d_d(d2(n2,:),d1(n1,:),t3,dedt2d)
      call dt3q_d(d2(n2,:),qu1(n1,:,:),t4,dedt3qa)
      call dt3q_d(d1(n1,:),qu2(n2,:,:),t4,dedt3qb)
c     call dt4o_d(d2(n2,:),oct1(n1,:,:,:),t5,dedt4oa)
c     call dt4o_d(d1(n1,:),oct2(n2,:,:,:),t5,dedt4ob)
...
c    .  +(dect3oa(k)-dect3ob(k))/15.d0
c    .  +(dect4ha(k)+dect4hb(k))/105.d0
     .  -dedt2d(k)
     .  +(-dedt3qa(k)+dedt3qb(k))/3.d0
c    .  -(dedt4oa(k)+dedt4ob(k))/15.d0
     .  +deqt4q(k)/9.d0
